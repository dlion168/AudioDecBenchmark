...
class Codec(BaseCodec):
    def config(self):
        self.setting = "audiodec_24k_300d"
        try:
        ...
        self.decoder_config_path = "audiodec_vocoder_24k_300d/checkpoint-500000steps.pkl"
